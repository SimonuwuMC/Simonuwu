...
const SEOHead = ({ 
  ...
  description = "Descarga el modpack más optimizado para Minecraft Fabric. Compatible con versiones 1.18.2 a 1.21.11. Incluye Sodium, Lithium, Iris Shaders y más mods kawaii.",
