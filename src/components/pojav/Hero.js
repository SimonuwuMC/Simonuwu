  ...
  return (
    <header className="bg-gradient-to-br from-red-500 to-red-800 dark:from-red-900 dark:to-red-950 py-20 px-6 text-center transition-colors">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-red-100 mb-4">📱 Pojav Launcher Edition</h2>
        {showEasterEgg && (
        ...
        <p className="text-xl text-red-100 mb-8">Modpack optimizado especialmente para dispositivos móviles con Pojav Launcher</p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a 
            href="https://modrinth.com/modpack/simonuwu-fabric-project-for-pojav" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          <a 
            href="/" 
            className="bg-red-600 dark:bg-red-800 text-white font-bold py-3 px-8 rounded-lg hover:bg-red-700 dark:hover:bg-red-900 transition-colors"
          >
            ← Versión Principal
          </a>
        </div>
